...
lytekControllers.controller("CharacterSheetCtrl", ["$scope", "MartialArts", "Merits", function ($scope, MartialArts, Merits) {
    ...
    $scope.casteList = [SolarCasteEnum.DAWN, SolarCasteEnum.ZENITH, SolarCasteEnum.TWILIGHT, SolarCasteEnum.NIGHT, SolarCasteEnum.ECLIPSE];
...
lytekControllers.controller("CharmBrowserCtrl", ["$scope", "$routeParams", "Charms", function ($scope, $routeParams, Charms) {
    $scope.charms = [];
